...
export default function Photos() {
  const localImages = [
    ...
    { src: image101, alt: "", gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" },
    { src: image102, alt: "", gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" },
    { src: image103, alt: "", gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" },
